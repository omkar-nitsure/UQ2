...
from datasets import get_train, get_id
...
def train_model(l_gradient_penalty, length_scale, final_model):
    ...
    x_val, y_val = x_test[:4000], y_test[:4000]
    ...
    trainer.run(dl_train, max_epochs=200)
    ...
    for l_gradient_penalty in l_gradient_penalties:
        for length_scale in length_scales:
            ...
            for _ in range(repetition):
                ...
                torch.save(model.state_dict(), f"models/LeNet_{length_scale}.pt")